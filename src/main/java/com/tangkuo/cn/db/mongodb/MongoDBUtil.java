package com.tangkuo.cn.db.mongodb;
...
//	        }
	        // 从配置文件中获取属性值
	        String ip = Configuration.getValue("mongdb_host");
	        int port = Integer.parseInt(Configuration.getValue("mongdb_port"));
	        
//	        String ip = "120.78.231.86";
//	        int port = 27018;
	        
	        String user_name = "tlk";
	        String password = "tlk@123";
	     ...
	     // // ServerAddress()两个参数分别为 服务器地址 和 端口
			...
			MongoCredential credential = MongoCredential.createScramSha1Credential(user_name,"tlink",password.toCharArray());
...
//	        boolean auth = db.(myUserName, myPassword);
	 ...
	 * @param args
	 */
	public void write(String HL7Msg) {
	...
	public void addSensorData(List<Document> list,String collName){
		String dbName = "tlink";
		MongoCollection<Document> coll = MongoDBUtil.instance.getCollection(dbName, collName);
		try {
