package com.tangkuo.cn.interceptor;
...
/*
 * 
* @ClassName: MyInterceptorDemo
* @Description: ()
* @author 
* @date 2017年10月21日 下午4:14:05
*
 */
...
public class MyInterceptorDemo implements Interceptor {
	...
	private Page<?> page;
	private static Log log = LogFactory.getLog(MyInterceptorDemo.class);
