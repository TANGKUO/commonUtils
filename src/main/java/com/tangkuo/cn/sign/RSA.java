...
public class RSA {
	...
	public static String sign(String content, String privateKey, String input_charset) {
		try {
			...
			KeyFactory keyf = KeyFactory.getInstance(Constants.SIGN_TYPE_RSA);
