...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String getDateString(String dateStr, String pattern) throws Exception {
		SimpleDateFormat sf = new SimpleDateFormat(pattern);
	 ...
	 * @throws Exception
	 */
	public static long dateDiff(Date sourceDate, Date objectDate) throws Exception {
	...
	public static long dateDiff(Date sourceDate, Date objectDate, int field) throws Exception {
		long nd = 1000 * 24 * 60 * 60;// 一天的毫秒数
		long nh = 1000 * 60 * 60;// 一小时的毫秒数
		long nm = 1000 * 60;// 一分钟的毫秒数
