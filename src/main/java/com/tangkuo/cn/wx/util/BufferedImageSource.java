...
public class BufferedImageSource extends LuminanceSource{
    ...
    public BufferedImageSource(BufferedImage image, int left,
    ...
    public LuminanceSource crop(int left, int top, int width, int height) {
        return new BufferedImageSource(image, this.left + left,
    ...
    public LuminanceSource rotateCounterClockwise() {
        ...
        g.dispose();
        int width = getWidth();
        return new BufferedImageSource(rotatedImage, top,
